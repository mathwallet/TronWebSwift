...
extension TronABI.Element {
    ...
    public enum ParameterType: TronABIElementPropertiesProtocol {
        ...
        var subtype: TronABI.Element.ParameterType? {
            switch self {
        ...
        var arraySize: TronABI.Element.ArraySize {
            switch self {
...
extension TronABI.Element.ParameterType: Equatable {
    public static func ==(lhs: TronABI.Element.ParameterType, rhs: TronABI.Element.ParameterType) -> Bool {
        switch (lhs, rhs) {
...
extension TronABI.Element.Function {
...
extension TronABI.Element.ParameterType: TronABIEncoding {
...
extension TronABI.Element.ParameterType: TronABIValidation {

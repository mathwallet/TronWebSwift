...
public extension TronABI {
    ...
    struct Record: Decodable {
        ...
        public var inputs: [TronABI.Input]?
        public var outputs: [TronABI.Output]?
...
extension TronABI.Element {
    public func encodeParameters(_ parameters: [AnyObject]) -> Data? {
        ...
        case .constructor(let constructor):
            ...
            guard let data = TronABIEncoder.encode(types: constructor.inputs, values: parameters) else {return nil}
            return data
        case .event(_):
            return nil
        case .fallback(_):
        ...
        case .function(let function):
            ...
            guard let data = TronABIEncoder.encode(types: function.inputs, values: parameters) else {return nil}
...
extension TronABI.Element {
    public func decodeReturnData(_ data: Data) -> [String:Any]? {
        ...
        case .function(let function):
            ...
            var returnArray = [String:Any]()
            var i = 0;
            guard let values = TronABIDecoder.decode(types: function.outputs, data: data) else {return nil}
    ...
    public func decodeInputData(_ rawData: Data) -> [String: Any]? {
        ...
        case .constructor(let function):
            ...
            var returnArray = [String:Any]()
            var i = 0;
            guard let values = TronABIDecoder.decode(types: function.inputs, data: data) else {return nil}
...
extension TronABI.Element.Event {
    public func decodeReturnedLogs(eventLogTopics: [Data], eventLogData: Data) -> [String:Any]? {
        guard let eventContent = TronABIDecoder.decodeLog(event: self, eventLogTopics: eventLogTopics, eventLogData: eventLogData) else {return nil}
        return eventContent
    }
}

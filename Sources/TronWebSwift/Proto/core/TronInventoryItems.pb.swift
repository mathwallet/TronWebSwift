...
public struct Protocol_InventoryItems {
...
extension Protocol_InventoryItems: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".InventoryItems"
  ...
  public static func ==(lhs: Protocol_InventoryItems, rhs: Protocol_InventoryItems) -> Bool {
